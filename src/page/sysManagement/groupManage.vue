<template>
    <div class="app-container">
            ...
            <el-col :span="24" class="toolbar">
                <el-form :inline="true" :model="filters">
                    <el-form-item label="模糊搜索">
                        <el-input v-model="filters.allItem" placeholder="输入小组，门店，部门，公司名称搜索"></el-input>
                    </el-form-item>
        ...
        <el-table :data="pagination.content" :height="heightNum" v-loading="isLoading" highlight-current-row border stripe>
            ...
            <el-table-column show-overflow-tooltip prop="groupName" label="小组名称" min-width="200"></el-table-column>
    ...
    export default {
        ...
        methods: {
            ...
            loadPagination() {
                ...
                this.isLoading = true;
                 console.log(params);
                http.post("v1.0.0/group/groupPage", params).then(response => {
